        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              A comprehensive disaster management and alert system designed to keep communities safe from landslides and floods through real-time monitoring and emergency notifications.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-2">
                ...
                <span className="text-gray-400">poshik@gmail.com</span>
              </li>
              <li className="flex items-center space-x-2">
                <FiPhone className="w-4 h-4 text-gray-400" />
                <span className="text-gray-400">+91 7019600288</span>
              </li>
              <li className="flex items-center space-x-2">
